...
El unico test que de verdad importa en este proyecto.

Lee el campo 'task' del contrato: con un modelo de regresion compara el
numero; con uno de clasificacion compara la etiqueta Y las probabilidades,
porque una etiqueta sola no detecta el error mas comun de esta costura:
